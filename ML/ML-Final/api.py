...
def predict():
    try:
        ...
        error_message = "An error occurred during prediction. Please make sure the image is well-angled, well-lit, and clear."
        # print("Prediction error:", str(e))
        paragraph = error_message
        # You can also take additional actions here, such as logging the error or notifying the user
        return jsonify({'predicted_paragraph': paragraph.lower()})
